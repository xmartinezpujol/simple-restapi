  ...
  render(){
    return(
      <div onClick={this.props.onCloseModal} className='modal' data-open={this.props.status}>
        ...
        <a href={window.restapi.serverURL + this.props.keyword + '/' + this.props.imgsel + '.jpg'} download>
        ...
        <img src={window.restapi.serverURL + this.props.keyword + '/' + this.props.imgsel + '.jpg'} />
      </div>
    );
  }
}
